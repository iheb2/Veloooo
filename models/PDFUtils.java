...
// centre =velo
    ...
    public static void createStyledPDF(Velo velo, User client, String idDocument) {
        ...
        try {
            ...
            Paragraph chapterTitle = new Paragraph("FActure pour Commande: ", blueFont);
            ...
            document.add(new Paragraph(velo.getNom()));
            Paragraph paragraphUserr = new Paragraph("Nom Client: ", redFont);
            document.add(paragraphUserr);
            document.add(new Paragraph(client.getFirstname() + " "));
